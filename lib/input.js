...
var Input = (function () {
	...
	function normaliseEvent(event) {
	 	if (!event.stopPropagation) {
	 		...
	 		event.preventDefaultv = function() {this.returnValue = false;};
	  	}
	  	if (!event.stop) {
	    	event.stop = function() {
	...
	Input.addHandler = function addHandler ( node, type, handler )
	{
	...
	Input.removeHandler = function removeHandler(object) {
