define(function(require) {
    ...
    var Layer = function(type, params) {
        ...
        if (type === Layer.TYPE_SHEET) {
            ...
            this.div.style.left   = -dims.cwidth/2  + "px";
            this.div.style.top    = -dims.cheight/2 + "px";   
            ...
            this.div.style.left = (-params[0]) + "px";
            this.div.style.top  = (-params[0]) + "px";
            ...
            this.div.style.left   = -params[0]/2 + "px";
            this.div.style.top    = -params[1]/2 + "px";
    ...
    var Actors = function (params) {
        ...
        if (params.relative !== undefined && params.relative === false) { /* Set the top div to absolute positioning to make it easy to move. */
            this.div.style.position = "absolute";
        }
    ...
    function collidesWithBitmap(x1, y1, x2, y2, width, height, bitmap) {
        ...
        var x1left = x1 - (layer.canvas.width>>>1);
        var y1top  = y1 - (layer.canvas.height>>>1);
